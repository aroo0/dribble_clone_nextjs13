  ...
  return (
    <section className="w-full h-[680px] md:h-[560px] flex flex-col gap-8 items-center bg-black text-white relative overflow-hidden py-12">
      ...
      <div className="z-30 flex flex-col gap-6 px-4">
        <h3 className="text-2xl md:text-3xl font-extrabold max-w-[500px] mx-auto text-center">
          Explore the world’s leading design portfolios
        </h3>
        <p className="text-sm md:text-base max-w-[650px] mx-auto text-center leading-7">
      ...
      <ul className="flex flex-wrap gap-3 z-30 items-center justify-center px-4 pt-4">
        ...
        {trendingSearch.map((value: string) => (
          <li
            key={value}
            onClick={() => handleTrendingSearch(value)}
            className="text-sm border border-[rgba(255,255,255,0.6)] px-4 py-1 rounded-full hover:border-white transition-all duration-500 cursor-pointer"
          >
            {value}
          </li>
        ))}
      ...
      <div className="absolute inset-0">
        ...
        >
          <source
            src="/49dbf46eae15d227fc95a69cee31251e.mp4"
            type="video/mp4"
          />
